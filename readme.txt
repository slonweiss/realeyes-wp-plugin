...
OAuth Page Protector allows you to protect specific pages on your WordPress site using OAuth/OIDC authentication. It's perfect for sites that need to restrict access to certain content using existing OAuth providers.
...
Yes, the plugin follows OAuth security best practices including state validation and secure cookie handling.
